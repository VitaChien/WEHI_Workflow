...
1- Request an access to Milton HPC 
Through Nextflow and Seqera on Milton HPC
Submit tickets to ask for access to Milton HPC and Seqera
Upload raw data to /vast/scratch/users/yourname/ + any subfolder you desire
Generate access token on Seqera and fill it in the Nextflow Tower Agent page
Select Sarek_344 from Lanchpad and launch it
 
Fill in Run setup configuration and lanch the pipeline
